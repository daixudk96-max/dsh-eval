...
const zh = {
  ...
  'view.retry': '重试',
  'view.loading': '加载中…',
  'view.loadingPreset': '解析会话预设中…',
  'view.noPreset': '此会话未绑定预设。可去模式选择器选择一个预设后返回。',
  'view.noChain': '预设 {preset} 尚无版本链。可先初始化安装该预设到版本库。',
  'view.scopedTo': '版本链 · {preset}',
  'view.revision': '审计修订',
...
const en = {
  ...
  'view.loadingPreset': 'Resolving session preset…',
  'view.noPreset': 'This session has no preset. Pick one in the mode selector and come back.',
  'view.noChain': 'Preset {preset} has no version chain yet. Initialize it into the registry first.',
  'view.scopedTo': 'Version chain · {preset}',
